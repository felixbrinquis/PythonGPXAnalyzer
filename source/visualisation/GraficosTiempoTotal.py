...
def TabGraficosTiempoTotal(df):
    ...
    dfBokeh['DeltaTiempo'] = (dfBokeh['Hora']-dfBokeh['Hora'].shift()).fillna(0)
    ...
    PLT_FrecuenciaCardiaca_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (min(MIN_FrecuenciaCardiaca[0], 85), max(MAX_FrecuenciaCardiaca[0], 180)), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    CodigoJSFrecuenciaCardiaca.args = dict(l0=PLT_FC_Ritmo_TMT, l1=PLT_FC_Altitud_TMT, l2=PLT_FC_Cadencia_TMT, l3=PLT_FC_Temperatura_TMT, l4=PLT_FC_Pendiente_TMT, l5=PLT_FC_Desnivel_TMT, l6=PLT_FC_Zancada_TMT, checkbox=BotonesGraficaFC)
    ...
    """
    # Creacion de un grafica
    PLT_VelocidadCalculada_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (MIN_Velocidad[0]-MIN_Velocidad[0]*0.1, MAX_Velocidad[0]+MAX_Velocidad[0]*0.2), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    CodigoJSVelocidad.args = dict(l0=PLT_V_FrecuenciaCardiaca_TMT, l1=PLT_V_Altitud_TMT, l2=PLT_V_Cadencia_TMT, l3=PLT_V_Temperatura_TMT, l4=PLT_V_Pendiente_TMT, l5=PLT_V_Desnivel_TMT, l6=PLT_V_Zancada_TMT, checkbox=BotonesGraficaVelocidad)
    ...
    """
    # Creacion de un grafica
    PLT_Altitud_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (MIN_Altitud[0]-(MAX_Altitud[0]-MIN_Altitud[0])*OffsetInferiorAltitud, MAX_Altitud[0]+(MAX_Altitud[0]-MIN_Altitud[0])*OffsetSuperiorAltitud), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    # Efectos visuales
    if DesnivelPorKilometro > 40:
        PLT_Altitud_TMT.add_tools(HoverTool(tooltips=[('Distancia', '@TiempoTotal{0.0} km'),('Altitud', '@AltitudCalculada{int} m'),('Desnivel positivo', '@DesnivelPositivoAcumulado{int} m'),('Pendiente', '@Pendiente{0.00}%')], renderers= [PLT_ALT_Altitud_TMT], mode= 'vline'))
    else:
        PLT_Altitud_TMT.add_tools(HoverTool(tooltips=[('Distancia', '@TiempoTotal{0.0} km'),('Altitud', '@AltitudCalculada{int} m')], renderers= [PLT_ALT_Altitud_TMT], mode= 'vline'))
    ...
    CodigoJSAltitud.args = dict(l0=PLT_ALT_FC_TMT, l1=PLT_ALT_Ritmo_TMT, l2=PLT_ALT_Cadencia_TMT, l3=PLT_ALT_Temperatura_TMT, l4=PLT_ALT_Pendiente_TMT, l5=PLT_ALT_Desnivel_TMT, l6=PLT_ALT_Zancada_TMT, checkbox=BotonesGraficaALT)
    ...
    """
    # Creacion de un grafica
    PLT_Cadencia_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (MIN_Cadencia[0]-(MAX_Cadencia[0]-MIN_Cadencia[0])*0.03, MAX_Cadencia[0]+(MAX_Cadencia[0]-MIN_Cadencia[0])*0.1), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    CodigoJSCadencia.args = dict(l0=PLT_C_FC_TMT, l1=PLT_C_Ritmo_TMT, l2=PLT_C_Altitud_TMT, l3=PLT_C_Temperatura_TMT, l4=PLT_C_Pendiente_TMT, l5=PLT_C_Desnivel_TMT, l6=PLT_C_Zancada_TMT, checkbox=BotonesGraficaCadencia)
    ...
    """
    # Creacion de un grafica
    PLT_Temperatura_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (min(MIN_Temperatura[0], 0), MAX_Temperatura[0]+(MAX_Temperatura[0]-MIN_Temperatura[0])*0.1), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    CodigoJSTemperatura.args = dict(l0=PLT_TMP_FC_TMT, l1=PLT_TMP_Ritmo_TMT, l2=PLT_TMP_Altitud_TMT, l3=PLT_TMP_Cadencia_TMT, l4=PLT_TMP_Pendiente_TMT, l5=PLT_TMP_Desnivel_TMT, l6=PLT_TMP_Zancada_TMT, checkbox=BotonesGraficaTMP)
    ...
    """
    # Creacion de un grafica
    PLT_Pendiente_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (MIN_Pendiente[0]-(MAX_Pendiente[0]-MIN_Pendiente[0])*0.05, MAX_Pendiente[0]+(MAX_Pendiente[0]-MIN_Pendiente[0])*0.05), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    PLT_Pendiente_TMT.line('TiempoTotal', 'Pendiente', source= DatosBokeh, color= paleta_verde[6], line_width= 2, line_cap= 'round')
    ...
    CodigoJSPendiente.args = dict(l0=PLT_PEN_FC_TMT, l1=PLT_PEN_Ritmo_TMT, l2=PLT_PEN_Altitud_TMT, l3=PLT_PEN_Cadencia_TMT, l4=PLT_PEN_Temperatura_TMT, l5=PLT_PEN_Desnivel_TMT, l6=PLT_PEN_Zancada_TMT, checkbox=BotonesGraficaPEN)
    ...
    """
    # Creacion de un grafica
    PLT_DesnivelPositivo_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (0, DesnivelPositivo+DesnivelPositivo*0.05), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    PLT_DesnivelPositivo_TMT.line('TiempoTotal', 'DesnivelPositivoAcumulado', source= DatosBokeh, color= paleta_verde[6], line_width= 2, line_cap= 'round')
    ...
    CodigoJSDesnivelPositivo.args = dict(l0=PLT_DPA_FC_TMT, l1=PLT_DPA_Ritmo_TMT, l2=PLT_DPA_Altitud_TMT, l3=PLT_DPA_Cadencia_TMT, l4=PLT_DPA_Temperatura_TMT, l5=PLT_DPA_Pendiente_TMT, l6=PLT_DPA_Zancada_TMT, checkbox=BotonesGraficaDPA)
    ...
    """
    # Creacion de un grafica
    PLT_Zancada_TMT = figure(width= 1000, height= 400, x_range= (0, dfBokeh['TiempoTotal'].max()), y_range= (MIN_LongitudZancada[0]-(MAX_LongitudZancada[0]-MIN_LongitudZancada[0])*0.03, MAX_LongitudZancada[0]+(MAX_LongitudZancada[0]-MIN_LongitudZancada[0])*0.1), x_axis_type= 'datetime', tools= '', toolbar_location= None)
    ...
    CodigoJSZancada.args = dict(l0=PLT_Z_FC_TMT, l1=PLT_Z_Ritmo_TMT, l2=PLT_Z_Altitud_TMT, l3=PLT_Z_Cadencia_TMT, l4=PLT_Z_Temperatura_TMT, l5=PLT_Z_Pendiente_TMT, l6=PLT_Z_Desnivel_TMT, checkbox=BotonesGraficaZAN)
    ...
    GridGraficaFC = gridplot(
            [PLT_FrecuenciaCardiaca_TMT, GridBotonesFC],
    ...
    GridGraficaVEL = gridplot(
            [PLT_VelocidadCalculada_TMT, GridBotonesVEL],
            ncols= 2, merge_tools= True, sizing_mode='fixed', toolbar_options=dict(logo=None)) 
    ...
    GridGraficaALT = gridplot(
            [PLT_Altitud_TMT, GridBotonesALT],
            ncols= 2, merge_tools= True, sizing_mode='fixed', toolbar_options=dict(logo=None))
    ...
    GridGraficaCAD = gridplot(
            [PLT_Cadencia_TMT, GridBotonesCAD],
            ncols= 2, merge_tools= True, sizing_mode='fixed', toolbar_options=dict(logo=None)) 
    ...
    GridGraficaTMP = gridplot(
            [PLT_Temperatura_TMT, GridBotonesTMP],
            ncols= 2, merge_tools= True, sizing_mode='fixed', toolbar_options=dict(logo=None)) 
    ...
    GridGraficaPEN = gridplot(
            [PLT_Pendiente_TMT, GridBotonesPEN],
            ncols= 2, merge_tools= True, sizing_mode='fixed', toolbar_options=dict(logo=None)) 
    ...
    GridGraficaDPA = gridplot(
            [PLT_DesnivelPositivo_TMT, GridBotonesDPA],
            ncols= 2, merge_tools= True, sizing_mode='fixed', toolbar_options=dict(logo=None))
    ...
    GridGraficaZAN = gridplot(
            [PLT_Zancada_TMT, GridBotonesZAN],
            ncols= 2, merge_tools= True, sizing_mode='fixed', toolbar_options=dict(logo=None)) 
